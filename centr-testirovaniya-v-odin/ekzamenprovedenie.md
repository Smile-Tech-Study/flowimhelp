...
✅ Каждый вопрос выбирается из нескольких вариантов (тест для  сдающего будет содержать один из 16 вариантов вопроса 1 (например, вариант 7), 1 из 16 вариантов вопроса 2 (например, вариант 4) и т.д).
