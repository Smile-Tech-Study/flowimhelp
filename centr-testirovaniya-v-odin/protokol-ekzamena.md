...
![](<../.gitbook/assets/image (12).png> "Пример протокола экзамена (ВНЖ, РВП). Начало экзамена - время начала попытки теста. Окончание экзамена - время завершения студентом письменной части (момент завершения прохождения теста).</p></figcaption></figure>

![](<../.gitbook/assets/image (176).png> "Пример протокола экзамена (Патент)</p></figcaption></figure>
