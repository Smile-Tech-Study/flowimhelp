...
<span class="comment"># Depends: libsane1</span>```
    <p>Соберите и установите пакет:</p>
    ```equivs-build libsane-dummy
sudo dpkg -i libsane_1.0.21_all.deb```
  </div>
