...
-  **требуется загрузить сертификата** - экзамен успешно сдан и в заявке необходимо заполнить данные сертификата (номер, дата, срок действия). 

-  **требуется загрузить скан сертификата** - экзамен сдан успешно, по нему заполнены все данные, теперь надо загрузить скан сертификата. [Загрузкой сканов  сертификатов](./sertifikaty/zagruzka-skana-sertifikata-v-zayavku) занимается сотрудник основного "Центра тестирования".
