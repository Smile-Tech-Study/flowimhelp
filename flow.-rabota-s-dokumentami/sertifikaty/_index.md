...
Во Flow на данный момент настроена печать и распознование сертификатов на бланках из типографий "СпецБланк-Москва" и "Киржачская типография". Также настроена печать сертификатов на бланках из типографии "НТ Граф", но для данной типографии не работает массовое распознавание сертификатов (пункт 2 настоящей инструкции) и потребуется [точечная загрузка ](./zagruzka-skana-sertifikata-v-zayavku)каждого сертификата в заявку.\
