...
-  **требуется загрузить скан сертификата** - экзамен успешно сдан и в заявке необходимо загрузить скан сертификата. [Загрузкой сканов  сертификатов](./sertifikaty/zagruzka-skana-sertifikata-v-zayavku) занимается сотрудник основного "Центра тестирования".
