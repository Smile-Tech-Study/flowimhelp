...
1. пролистать страницу вниз, нажать на кнопку «Перегенерировать ключ», подтвердить действие в открывшемся окне

![](./otpravka-sertifikatov-po-api-fis-frdo-3.png){width=1298px height=354px}

1. после генерации ключа обязательно выполнить нажать на кнопку «Сохранить». Ключ доступа готов к использованию.
