...
-  в состав конфликтной комиссии не могут входить сотрудники, входящие в состав экзаменационной комиссии.
   ...
   Назначить специалиста для контроля за качеством проведенных экзаменов.
...
2. Предоставить техническим специалистам данные [организации](./flow.-rabota-s-dokumentami/organizaciya) и [площадки](./flow.-rabota-s-dokumentami/stranica-ploshadki) для настройки их в системе Flow.
